...
export function generateListingHtml(form: EbayListingFormState): string {
  ...
  const fitmentRows = validFitment.length > 0
    ? validFitment.map((r, i) => {
        ...
        const yearRange = from && to ? `${from} – ${to}` : from ? `${from}+` : to ? `up to ${to}` : "—";
...
<div style="font-family:Georgia,'Times New Roman',serif;background:#0a0a0a;color:#e5e2e1;max-width:1100px;margin:0 auto;border:1px solid #c5a059;">

  <div style="background:linear-gradient(180deg,#1a1a1a 0%,#0a0a0a 100%);padding:32px 40px;border-bottom:2px solid #c5a059;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td valign="middle">${LOGO_SVG_INLINE}</td>
        <td valign="middle" align="right">
          <div style="font-family:Arial,sans-serif;font-size:10px;color:#8a8070;letter-spacing:2px;text-align:right;">AUTHORISED RESELLER</div>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#111111;border-bottom:1px solid #2a2520;">
    <tr>
      <td width="25%" align="center" style="padding:20px 12px;border-right:1px solid #2a2520;">
  ...
  <div style="background:linear-gradient(135deg,#1a1611 0%,#0a0a0a 60%,#0a0a0a 100%);padding:48px 40px;border-bottom:1px solid #2a2520;">
    <h1 style="font-family:Georgia,serif;font-size:28px;line-height:1.25;color:#f8e19b;margin:0 0 16px 0;font-weight:normal;letter-spacing:0.5px;">${title}</h1>
    <div style="width:60px;height:2px;background:#c5a059;margin-top:8px;"></div>
  </div>

  <div style="background:#0e0e0e;padding:40px;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr valign="top">
        <td width="56%" style="vertical-align:top;padding-right:24px;">
          <h2 style="font-family:Georgia,serif;font-size:22px;color:#e9c176;margin:0 0 4px 0;font-weight:normal;letter-spacing:1px;">Technical Specifications</h2>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#141414;border:1px solid #2a2520;">
            ...
            <tr>
              ...
              <td style="padding:14px 18px;border-bottom:1px solid #2a2520;">
                <div style="font-family:Arial,sans-serif;font-size:9px;color:#8a8070;letter-spacing:3px;margin-bottom:6px;">YEAR</div>
                <div style="font-family:Georgia,serif;font-size:15px;color:#f0e8d8;">${year}</div>
              </td>
            </tr>
            <tr>
  ...
  <div style="background:linear-gradient(180deg,#0a0a0a 0%,#0e0e0e 100%);padding:40px;border-top:1px solid #2a2520;">
    <h2 style="font-family:Georgia,serif;font-size:22px;color:#e9c176;margin:0 0 4px 0;font-weight:normal;letter-spacing:1px;">Vehicle Fitment</h2>
    <div style="width:40px;height:2px;background:#c5a059;margin-bottom:24px;"></div>
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#141414;border:1px solid #2a2520;">
  ...
  <div style="background:#0e0e0e;padding:40px;border-top:1px solid #2a2520;">
    <h2 style="font-family:Georgia,serif;font-size:22px;color:#e9c176;margin:0 0 4px 0;font-weight:normal;letter-spacing:1px;">Store Policies</h2>
  ...
  <div style="background:linear-gradient(180deg,#0a0a0a 0%,#0e0e0e 100%);padding:36px 40px;border-top:2px solid #c5a059;text-align:center;">
    ...
    <div style="margin-top:24px;">
      <table cellpadding="0" cellspacing="0" border="0" align="center">
        <tr>
          <td style="padding:0 16px;font-family:Arial,sans-serif;font-size:10px;color:#8a8070;letter-spacing:2px;">&#9733; &#9733; &#9733; &#9733; &#9733;</td>
          <td style="padding:0 16px;font-family:Arial,sans-serif;font-size:10px;color:#c5a059;letter-spacing:3px;">PARTSHUB &middot; AUSTRALIA</td>
          <td style="padding:0 16px;font-family:Arial,sans-serif;font-size:10px;color:#8a8070;letter-spacing:2px;">&#9733; &#9733; &#9733; &#9733; &#9733;</td>
        </tr>
      </table>
    </div>
