  ...
  <ModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-xs border border-border bg-bg p-6 shadow-2xl",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xs p-1 text-fg/40 transition hover:bg-bg-2 hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        <X className="h-4 w-4" />
