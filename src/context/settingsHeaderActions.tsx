...
// Lets a nested /settings/* page (e.g. a "Save Changes" button) render into SettingsLayout's sticky header bar instead of its own scrollable content, so the action stays visible while the page scrolls.
